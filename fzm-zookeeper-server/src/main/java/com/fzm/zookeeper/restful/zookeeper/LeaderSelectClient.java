 ...
 */
public class LeaderSelectClient extends LeaderSelectorListenerAdapter implements Closeable {

    private String name;
    private LeaderSelector leaderSelector;

    public LeaderSelectClient(CuratorFramework curatorFramework, String name, String path) {
        this.name = name;
    ...
    public static void main(String[] args) throws Exception {
        ...
        LeaderSelectClient clientA = new LeaderSelectClient(curatorFramework, "ClientA", "/leader");
        clientA.start();
        System.in.read();
    }
}
